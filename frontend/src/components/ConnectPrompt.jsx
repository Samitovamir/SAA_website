  ...
  return (
    <div className="cp-page">
      ...
      <style>{`
        ...
        .cp-ic { width: 64px; height: 64px; border-radius: 18px; background: rgba(129,140,248,0.14); color: var(--accent); display: flex; align-items: center; justify-content: center; }
