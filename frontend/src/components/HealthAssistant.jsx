  ...
  return (
    <>
        ...
        {expanded && (
          <motion.div className="ha-panel"
            ...
            <div className="ha-input-row">
              ...
              <input className="ha-input" placeholder={t.placeholder} value={input} autoFocus
      ...
      <style>{`
        ...
        .ha-input-row { display: flex; align-items: center; gap: 8px; background: var(--bg-secondary); border: 1px solid var(--border); border-radius: 12px; padding: 6px 6px 6px 12px; transition: border-color 0.2s; }
        .ha-input-row:focus-within { border-color: var(--border-hover); }
        .ha-input { flex: 1; border: none; background: transparent; outline: none; font-family: inherit; font-size: 14px; color: var(--foreground); }
