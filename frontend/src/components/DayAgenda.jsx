...
export default function DayAgenda() {
  ...
  const AI_CONTEXT =
    'Ты помощник владельца по дню. Дай ОДНО короткое практичное предложение: как пройти сегодняшний день с учётом расписания и состояния (спорт/здоровье). Без вступлений, одно предложение.' +
