...
// Кухня пользователя и стиль блюд — общие ограничения для подбора и рецептов
const KITCHEN = 'Важно: у пользователя НЕТ духовки — есть конвектомат (пароконвектомат) и обычная плита со сковородой/кастрюлей. ' +
